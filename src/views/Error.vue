            ...
            <el-card class="statistics-card total-card">
              <div class="statistics-content">
                ...
                <div class="statistics-info">
                  <div class="statistics-number">{{ statistics.total || 0 }}</div>
          ...
          <el-col :span="6">
            <el-card class="statistics-card warning-card">
              <div class="statistics-content">
                ...
                <div class="statistics-info">
                  <div class="statistics-number">{{ statistics.warningCount || 0 }}</div>
          ...
          <el-col :span="6">
            <el-card class="statistics-card error-card">
              <div class="statistics-content">
                ...
                <div class="statistics-info">
                  <div class="statistics-number">{{ statistics.errorCount || 0 }}</div>
          ...
          <el-col :span="6">
            <el-card class="statistics-card other-card">
              <div class="statistics-content">
                ...
                <div class="statistics-info">
                  <div class="statistics-number">{{ statistics.otherTypesCount || 0 }}</div>
          ...
          <el-col :span="12">
            ...
            <el-card style="height: 480px;">
              <div style="padding: 20px; text-align: center;">
                <h3>统计详情</h3>
                <el-divider />
                <div v-for="item in statistics.pieChartData" :key="item.type" class="detail-item">
...
const fetchErrorStatistics = async () => {
  try {
    const response = await axios.get('http://localhost:3000/api/error-statistics')
...
const fetchErrorMessages = async () => {
  try {
    ...
    const response = await axios.get('http://localhost:3000/api/error-messages', {params})
